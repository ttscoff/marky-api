...
class Readability
{
	...
	**/
	public $regexps = array(
		...
		'positive' => '/article|body|content|entry|hentry|main|page|attachment|pagination|post|text|blog|story|task-list/i',
		'negative' => '/combx|comment|com-|contact|foot|footer|_nav|footnote|masthead|meta|outbrain|promo|related|scroll|shoutbox|sidebar|sponsor|shopping|tags|tool|widget/i',
